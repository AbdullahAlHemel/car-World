...
const SingleBugatti = () => { const carData = useLoaderData();
    ...
    const handleDelete = _id => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              fetch(`https://car-server-abdullahalhemel.vercel.app/bugatti/${_id}`,{
                method:'DELETE',
    ...
    return (
        ...
        <div className='m-auto md:w-[1000px]  h-[290px] md:h-[500px] flex sm:flex-row'>
          ...
          <img className=' md:w-[600px] w-full md:max-h-[350px] md:my-10 m-auto' src={photo} alt="" />
            </div>

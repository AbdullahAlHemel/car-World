...
const SingleTesla = () => { const carData = useLoaderData();
    ...
    const handleDelete = _id => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              fetch(`https://car-server-abdullahalhemel.vercel.app/tesla/${_id}`,{
                method:'DELETE',

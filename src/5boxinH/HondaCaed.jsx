...
const HondaCard = ({car, cars, setCar }) => {  
         ...
         <div className='flex p-10'>
             <div className="md:float-right md:w-[450px] w-[200px]">
              ...
              <p>
              {
                        ...
                        <Link to={`/honda/${_id}`} className='rounded btn-primary hover:translate-y-1 underline p-1.5 m-2 text-white bg-yellow-900 '>Details</Link>
